...
# 3. 抓取图片的总目标数量
TOTAL_IMAGES_TO_FETCH = 50
# 4. 搜索关键词 (为了多样性，涵盖男女小孩)
SEARCH_QUERIES = [
    # 小孩
    "Full-body color photo of a black little girl",

    # # 男女青年
    # "full body portrait of young man",
    # "full body portrait of young woman",
    # "handsome man",
    # "beautiful woman",

    # # 不同地区面孔
    # "full body portrait of caucasian",
    # "full body portrait of african",
    # "full body portrait of asian",
    # "full body portrait of hispanic"
]
